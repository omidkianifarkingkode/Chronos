...
```text
https://github.com/<owner>/<repo>.git?path=/Assets/Chronos
```
...
3. Paste the Git URL above (replace `<owner>/<repo>` with your repository path).
4. Press **Add**.
...
- **Window → Chrono Module → Create Chronos Bootstrapper**
